...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
#define TIMEOUT_INTERVAL_MS 10000  // Time interval in milliseconds (10 seconds)
...
uint32_t remainingMillis = TIMEOUT_INTERVAL_MS;
/* USER CODE END PV */
...
//	    	printf("Wake up from the stop mode in mainloop\r\n");
 }
