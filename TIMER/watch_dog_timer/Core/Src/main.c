    ...
    /* USER CODE BEGIN 3 */
     //used to detect software faults wwdg
	  HAL_Delay (1);
	      ...
	      //Able to refresh in periodic timing so led will be on
	      	 	  //if we fail to over timing this system will reset and led keep blinking
	      	 	  //note;-if led on so that will be indicate watchdog is
	      	 	  // Refresh within time limit.
