...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //Able to refresh  so led will be on
	  	 	  //if we fail to over timeing this system will reset and led keep blinking
	  	 	  //note;-if led on so that will be indicat wachdog is
	  	 	  // refrash within time limit.
