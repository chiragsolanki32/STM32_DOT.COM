...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  BTN_Pin=  HAL_GPIO_ReadPin(GPIOC, BTN_Pin);//RETURJ THR PUSH BUTTON
if(BTN_GPIO_Port==GPIO_PIN_SET);

{//turn on led
	 HAL_GPIO_WritePin(GPIOPB7, LED_Pin, GPIO_PIN_SET);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(BTN_Pin_GPIO_Port, BTN_Pin_Pin, GPIO_PIN_RESET);
