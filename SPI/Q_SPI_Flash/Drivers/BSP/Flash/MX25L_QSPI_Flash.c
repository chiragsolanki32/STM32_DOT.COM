...
uint8_t BSP_QSPI_GetInfo(QSPI_Info *pInfo) {
	...
	pInfo->FlashSize = MX25L32_FLASH_SIZE;
	pInfo->EraseSectorSize = MX25L32_SUBSECTOR_SIZE;
	pInfo->EraseSectorsNumber = (MX25L32_FLASH_SIZE / MX25L32_SUBSECTOR_SIZE);
	pInfo->ProgPageSize = MX25L32_PAGE_SIZE;
	pInfo->ProgPagesNumber = (MX25L32_FLASH_SIZE / MX25L32_PAGE_SIZE);
...
uint8_t BSP_QSPI_EnableMemoryMappedMode(void) {
	...
	s_command.DummyCycles = MX25L32_DUMMY_CYCLES_READ_QUAD_IO;
	s_command.DdrMode = QSPI_DDR_MODE_DISABLE;
	s_command.DdrHoldHalfCycle = QSPI_DDR_HHC_ANALOG_DELAY;
	s_command.SIOOMode = QSPI_SIOO_INST_EVERY_CMD;
