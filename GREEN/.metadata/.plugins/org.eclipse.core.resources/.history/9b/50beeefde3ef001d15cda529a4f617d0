...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  BUTTON= HAL_GPIO_ReadPin(BSP_BTN_GPIO_Port,BSP_LED_Pin);
	if(  BUTTON==1)
	{
		HAL_GPIO_WritePin(BSP_BTN_GPIO_Port,BSP_LED_Pin, SET);
	}
	else
	{
		HAL_GPIO_WritePin(BSP_BTN_GPIO_Port,BSP_LED_Pin, RESET);
	}
