...
//void i2c_recv_data(I2C_TypeDef *i2c_handle, uint8_t address, uint8_t *data, uint8_t num_of_data)
//{
//}
//void i2c_write_data(I2C_TypeDef *i2c_handle, uint8_t address, uint8_t *data, uint8_t num_of_data)
//{
//}
...
static inline void i2c_SHT2x_write_reg(uint8_t reg_address, uint8_t data)
{
   ...
   // HAL_I2C_Mem_Write_IT(&hi2c1, SHT21_WRITE_ADDRESS, reg_address, I2C_MEMADD_SIZE_8BIT, &data, 1);
...
//	 HAL_I2C_Master_Transmit_IT(&hi2c1, SHT21_WRITE_ADDRESS, &reg_address, 1);
//	 static int flag = 0;
//	 if(1)
//	 {
//		 HAL_I2C_Master_Receive(&hi2c1, SHT21_READ_ADDRESS, data, nbr_of_data,100);
